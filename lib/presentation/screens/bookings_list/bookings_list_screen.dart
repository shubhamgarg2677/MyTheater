...
class _BookingsListScreenState extends State<BookingsListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.only(left: AppSizeUtils.wholePadding, right: AppSizeUtils.wholePadding),
        child: FutureBuilder<Map<int, BookingDetailModel>?>(
  ...
  Future<void> onOpenTicket(BookingDetailModel? bookingDetailModel) async {
    if(bookingDetailModel!=null && bookingDetailModel.movieId!=null && bookingDetailModel.bookingId!=null){
      MovieItemModel? movieItemModel = await dataDbRepositories.getMovieItem(bookingDetailModel.movieId!);
